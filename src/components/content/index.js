                ...
                <NavLink to={
                   {
                    ...
                    <div className="relative h-36 w-44">
                        ...
                        <button className="absolute bottom-2 text-sm right-2 uppercase z-10 px-2 py-1 bg-btnSmColor rounded-full">{this.props.news.categoryName}</button>
                    </div>
                    
                    <div className="ml-8 w-80">
                        <h2 className="text-[#252641] text-base font-medium leading-7 pt-2">{this.props.news.title}</h2>
