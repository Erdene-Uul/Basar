...
const Sidebar = (props) => {
  return (
    <div className="fixed h-auto w-2/3 sm:w-2/4 lg:hidden bg-gray-500 top-11 font-Roboto">
      <ul className="flex flex-col font-thin py-4 px-10">
        <div>
          <button className="bg-blueMain text-white duration-500 hover:bg-sky-700 rounded-3xl text-xs  relative flex items-center justify-center  lg:hidden ">
            <div className="h-2 w-5 bg-blue-600  rounded-full">
              <FontAwesomeIcon
